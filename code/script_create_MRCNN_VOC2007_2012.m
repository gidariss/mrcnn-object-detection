function script_create_MRCNN_VOC2007_2012

models_dir             = fullfile(pwd, 'models-exps');
net_def_file_directory = fullfile(pwd, 'model-defs');

% create the model directory
model_dir_dst          = fullfile(models_dir,    'MRCNN_VOC2007_2012');
...
model_net_def_file_scr = fullfile(net_def_file_directory, 'MRCNN_model_svm.prototxt');
...
model_feat_cache = 'VGG_ILSVRC_16_layers'; % code-name of the activation maps that the VGG16 convolutional layers produce
