...
ip.addOptional('feat_cache_name','VGG_ILSVRC_16_layers', @ischar);
...
net_weights_file = fullfile(net_files_dir,'VGG_ILSVRC_16_layers.caffemodel');
...
extract_conv_features_all_images(net, image_db.image_paths, feat_cache_dir_image_set, ...
    'start',opts.start,'end',opts.end,'scales',opts.scales,'mean_pix',opts.mean_pix);
